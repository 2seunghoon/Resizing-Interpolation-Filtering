...
void test_bl_resize()
{
    ...
    save_image(resized2, "713_467_bl_");
...
void test_highpass_filter(){
    ...
    clamp_image(blur);
    save_image(blur, "high_pass_test");
...
void test_hybrid_image(){
    ...
    save_image(lfreq_man, "low_frequency_man");
    save_image(lfreq_w, "low_frequency_woman");
    save_image(hfreq_w, "high_frequency_woman");
    save_image(reconstruct, "recon_hybrid");
...
void test_sobel(){
    ...
    save_image(mag, "mag_test");
    save_image(theta, "theta_test");
